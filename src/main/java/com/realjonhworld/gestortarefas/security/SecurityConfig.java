...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter, AuthenticationProvider authenticationProvider) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/tarefas/**").hasAnyAuthority("GESTOR", "FUNCIONARIO")
    ...
    public AuthenticationProvider authenticationProvider(UserDetailsService userDetailsService, PasswordEncoder passwordEncoder) {
        ...
        authProvider.setUserDetailsService(userDetailsService); // <- este precisa ser UserDetailsServiceImpl
